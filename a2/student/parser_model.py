...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        intermezzo = torch.index_select(self.embeddings,0,torch.flatten(w))
        x=intermezzo.view(len(w),-1)
    ...
    def forward(self, w):
        ...
        h_1=self.dropout(h)
        logits= torch.matmul(h_1,self.hidden_to_logits_weight) + self.hidden_to_logits_bias
